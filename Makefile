...
launch-net:
	@docker run -d -h docker.local --name $(NAME) -e "ENVIRONMENT=local" -e "KAMAILIO_LOG_LEVEL=debug" -e "ENABLE_SECONDARY_AMQP=true" -e "MY_WEBSOCKET_DOMAIN=kamailio.local" -p "5060:5060" -p "5060:5060/udp" -p "5064:5064" -p "5064:5064/udp" --network=local --net-alias kamailio.local $(LOCAL_TAG)
